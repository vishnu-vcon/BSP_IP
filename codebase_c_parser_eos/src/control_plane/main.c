...
int main(int argc, char *argv[])
{
     ...
     */
    token_auth_add_user(cp->auth, "admin",    "Admin@123",    "admin",    "");
    token_auth_add_user(cp->auth, "operator", "Operator@123", "operator", "");
    token_auth_add_user(cp->auth, "viewer",   "Viewer@123",   "viewer",   "");
