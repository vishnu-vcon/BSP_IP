...
int main(int argc, char *argv[]) {
    ...
    gst_rtsp_media_factory_set_launch(factory,
        ...
        "videoconvert ! video/x-raw,width=1920,height=1080,framerate=30/1,format=I420 ! "
        "v4l2h264enc name=hw_enc ! "
        "tee name=t "
        "t. ! queue ! h264parse ! rtph264pay name=pay0 pt=96 "
        "t. ! queue ! h264parse ! mp4mux ! filesink location=/root/recording.mp4 async=false )");
    ...
    g_print("NO PROPS Server active (MP4 enabled).\n");
