...
int main(int argc, char *argv[]) {
    ...
    gst_rtsp_media_factory_set_launch(factory,
        ...
        "videoconvert ! video/x-raw,width=1920,height=1080,framerate=30/1,colorimetry=bt709,format=NV12 ! "
        ...
        "t. ! queue ! mp4mux ! filesink location=/root/recording.mp4 async=false )");
